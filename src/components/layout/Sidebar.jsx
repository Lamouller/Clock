...
export function Sidebar({ isOpen, onClose }) {
  ...
  const menuItems = [
    ...
    { path: '/reports', label: 'Reports & Exports', icon: 'M2.5 2C2.22386 2 2 2.22386 2 2.5V12.5C2 12.7761 2.22386 13 2.5 13H12.5C12.7761 13 13 12.7761 13 12.5V2.5C13 2.22386 12.7761 2 12.5 2H2.5ZM3 3H12V12H3V3Z' },
    { path: '/settings', label: 'Account Settings', icon: 'M7.5 1.5C4.05 1.5 1.5 4.05 1.5 7.5C1.5 10.95 4.05 13.5 7.5 13.5C10.95 13.5 13.5 10.95 13.5 7.5C13.5 4.05 10.95 1.5 7.5 1.5ZM7.5 12C4.875 12 3 10.125 3 7.5C3 4.875 4.875 3 7.5 3C10.125 3 12 4.875 12 7.5C12 10.125 10.125 12 7.5 12Z' }
  ]
